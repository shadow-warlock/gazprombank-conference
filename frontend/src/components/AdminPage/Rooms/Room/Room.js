    ...
    render() {
        return (
            <div className={"room_info"}>
                ...
                <div className={"form_container"}><p>Видимость:</p><p>{this.props.room.visible ? "Видимая":"Скрытая"}</p></div>
                <br/>
                <div className={"pb_20"}><Button onClick={()=>{window.open("/room/" + this.props.room.id, "_blank")}}>Войти</Button></div>
                <Button onClick={()=>{
                    let self = this;
