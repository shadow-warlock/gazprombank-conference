    ...
    render() {
        return (
            <div className="tech-support">
                <h3 className="tech-support__title auth-white"><FormattedMessage id={"technical_support"} /></h3>
                            ...
                            techSupporter.use.includes(this.props.use) ?
                                <ul key={techSupporter.phone} className="tech-support__support">
                                    ...
                                    <li className="tech-support__item">
                                        <a className="auth-white" href={"tel:" + techSupporter.phone}>{techSupporter.phone}</a>
                                    </li>
                                    <li className="tech-support__item auth-white">
