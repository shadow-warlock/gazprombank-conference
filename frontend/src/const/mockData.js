export const CONFERENCE_ITEMS = [
  ...
  {
    id: 1,
    image: '/assets/speakers/bysko.jpg',
    name: '',
  ...
  },
  {
    id: 1.5,
    image: null,
    name: 'Обзор изменений законодательства  российской федерации в области валютного регулирования и валютного контроля',
    speaker: '',
    description: '',
    time: '09:40 - 11:00',
  },
  {
    id: 2,
    image: '/assets/speakers/shakina.jpg',
    name: '',
    speaker: 'Елена Шакина',
    description: 'Заместитель Директора Департамента финансового мониторинга и валютного контроля Центрального банка Российской Федерации',
    time: null,
  },
  {
    id: 2.5,
